			...
			try{
				...
				if (decisione == 2) {
					...
					do{
						...
						try{
						if (decisione == 2 ) {
							Film nuovoFilm = new Film(null, 0, null, null, null, 0);
							System.out.print("Titolo: ");
							nuovoFilm.setName(scanner.nextLine());
							scanner.nextLine();
							System.out.print("Anno di pubblicazione: ");
							nuovoFilm.setYear(scanner.nextInt());
							System.out.print("Regista: ");
							nuovoFilm.setDirector(scanner.nextLine());
							scanner.nextLine();
							System.out.print("Genere: ");
							nuovoFilm.setGenre(scanner.nextLine());
							System.out.print("Costo: ");
							nuovoFilm.setPrice(scanner.nextDouble());
							nuovoFilm.filmAggiunto();
						}
						...
						if (decisione == 3){
							...
							for (int i = 0; i < sezioneCinema.size(); i++) {
								if (titoloRimosso.equals(sezioneCinema.get(i).getName())) {
							...
							if (!trovato) {
								System.out.println("Il film non è presente nella lista");
							}
						}
						} 
				...
				if (decisione == 1) {
					...
					do{
						...
						if (decisione == 2) {
							...
							do{
							System.out.print("Codice ISBN: 978");
